...
public final class AgentConnectIdentityProviderFactory
  ...
  public List<ProviderConfigProperty> getConfigProperties() {
    ...
    return ProviderConfigurationBuilder.create()
        ...
        .helpText("Permet de fixer le niveau de garantie du compte utilisateur souhaité. Ignoré si la double authentification (2FA) est activée. Effet : désactive des fournisseurs d'identités (FI) sur la page de login AgentConnect.")
        .type(ProviderConfigProperty.LIST_TYPE)
        .options(eidasLevels)
