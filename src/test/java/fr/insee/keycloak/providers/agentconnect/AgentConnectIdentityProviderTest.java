...
class AgentConnectIdentityProviderTest {
  ...
  private AgentConnectIdentityProviderEidas1 providerEidas1;
  private AgentConnectIdentityProviderEidas2 providerEidas2;
  ...
  void setup() throws IOException {
    ...
    providerEidas1 = new AgentConnectIdentityProviderEidas1(session, config);
    providerEidas2 = new AgentConnectIdentityProviderEidas2(session, config);
  }
